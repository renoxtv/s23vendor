...
*/
#include "DM1_S6E3FAC_AMB606AW01_panel.h"
#include "DM1_S6E3FAC_AMB606AW01_mdnie.h"
#include "hwparam/DM1_S6E3FAC_AMB606AW01.hw_param.h"
...
/* UPDATE GAMMA_COMPENSATION */
static int update_analog1_DM1_S6E3FAC_AMB606AW01(
			struct samsung_display_driver_data *vdd,
...
#if 0
static int update_analog2_DM1_S6E3FAC_AMB606AW01(
			struct samsung_display_driver_data *vdd,
			char *val, struct ss_cmd_desc *cmd)
{
	int i = -1;
...
static int update_analog3_DM1_S6E3FAC_AMB606AW01(
			struct samsung_display_driver_data *vdd,
			char *val, struct ss_cmd_desc *cmd)
{
	int i = -1;
			...
			char *val, struct ss_cmd_desc *cmd)
{
	...
	if (glut_map) {
		...
		LCD_DEBUG(vdd, "bl_lvl: %d, cur_rr: %d, i: %d col_size : %dd, night_dim : %d\n",
...
{
	LCD_INFO(vdd, "DM1_S6E3FAC_AMB606AW01 : ++ \n");
	...
	register_op_sym_cb(vdd, "AOR", update_aor_DM1_S6E3FAC_AMB606AW01, true);
	register_op_sym_cb(vdd, "ANALOG_OFFSET_1",
			update_analog1_DM1_S6E3FAC_AMB606AW01, true);
#if 0
	register_op_sym_cb(vdd, "ANALOG_OFFSET_2",
			update_analog2_DM1_S6E3FAC_AMB606AW01, true);
	register_op_sym_cb(vdd, "ANALOG_OFFSET_3",
			update_analog3_DM1_S6E3FAC_AMB606AW01, true);
#endif
	update_glut_map(vdd);
}
